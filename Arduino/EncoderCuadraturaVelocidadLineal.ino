...
double u = 0.0;  // Velocidad lineal en m/s.
int cv = 0; // Valor regula ciclo de trabajo (PWM)

// dWheel = 0.067 Diametro de la llanta

double constValue = 0.1063; //(dWheel*1000*pi)/R ---> R = 1980 Resolucion encoder cuadruple
...
void computeU(void)
{
  u =(constValue*n)/(millis()-lastTime); // Calculamos velocidad rad/s
